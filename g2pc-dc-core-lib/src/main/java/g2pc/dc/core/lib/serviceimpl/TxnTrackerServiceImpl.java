...
public class TxnTrackerServiceImpl implements TxnTrackerService {
    ...
    public G2pcError saveRequestInDB(String requestString, String regType, String protocol,
                                     ...
                                     String inboundFilename) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
     ...
     */
    @Override
    public G2pcError updateTransactionDbAndCache(ResponseDTO responseDTO, String outboundFilename) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
